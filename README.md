# Integrating SQL Server with Debezium for CDC

Description of demo here

Follow along with [this tutorial on the Redpanda blog](https://redpanda.com/blog/change-data-capture-sql-server-debezium) to put this demo into action. 
